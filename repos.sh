...
case "$1" in
    ...
    "pull" )
        ...
        ;;
    "push" )
        git push git@github.com:$2/GHi.git
        ;;
    "changelog" )
        git log --oneline
        ;;
    ...
    "revert" )
        ...
        ;;
    "add_remote" )
        git remote add $2 git@github.com:$2/GHi.git
        ;;
    "pull_remote" )
        git remote add $2 git@github.com:$2/GHi.git || git fetch $2 && git merge $2/master
        ;;
    "fetch" )
        git fetch $2
        ;;
    ...
    "tag" )
        ...
        ;;
    "pushtag" )
        git push git@github.com:$2/GHi-private.git --tag
        ;;
    * ) 
        echo "Help"
